   ...
   return (
      <>
         <div className={style.root}>
            <input onChange={event => setSearchState(event.target.value)} value={searchState} className={style.input} placeholder='Поиск пиццы...' />
            ...
            {searchState && (
               <svg onClick={() => setSearchState('')} className={style.clearIcon} width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
